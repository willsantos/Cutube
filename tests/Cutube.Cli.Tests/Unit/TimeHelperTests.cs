...
public class TimeHelperTests
{
    ...
    {
        var result = Cutube.Cli.TimeHelper.GetStartSeconds(time);
    ...
    {
        Action act = () => Cutube.Cli.TimeHelper.GetStartSeconds(time);
    ...
    {
        var result = Cutube.Cli.TimeHelper.GetEndSeconds(time);
        result.Should().Be(expected);
    }
    ...
    {
        var result = Cutube.Cli.TimeHelper.GetTimeDiff(start, end);
        result.Should().Be(expected);
    }
    ...
    {
        var result = Cutube.Cli.TimeHelper.ParseToSeconds(input);
        result.Should().Be(expected);
    }
    ...
    {
        Action act = () => Cutube.Cli.TimeHelper.ParseToSeconds(input!);
